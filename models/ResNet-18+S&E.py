...
def res_identity(x, filter, r = 0): 
    ...
    x = BatchNormalization()(x)
    if r == 1:
      x_skip = Conv3D(filter, kernel_size=(3, 3,3), strides=(1, 1,1), padding='same', kernel_regularizer=l2(0.001))(x)
...
def resnet_18_se(input_shape,targets):
